...
```
## comparing files:
This was the first time they introduced the `diff` command. Time to experiment:
```
...
54a55
> pwn.college{IDply1KSoliIwJMAgVzEbysKNdC.QXzAzM4EDLyYjMxkzW}
hacker@commands~comparing-files:/challenge$
hacker@commands~comparing-files:/challenge$ 
```
and in this manner we got the flag for this challenge.
### Answer:
```
pwn.college{IDply1KSoliIwJMAgVzEbysKNdC.QXzAzM4EDLyYjMxkzW}
```
...
pwn.college{0Vgg4BZcP9ayyqoXOe3kyLuYnAe.QX2EDNxIDLyYjMxkzW}

hacker@commands~copying-files:~$ 
```
### Answer:
```
pwn.college{0Vgg4BZcP9ayyqoXOe3kyLuYnAe.QX2EDNxIDLyYjMxkzW}
